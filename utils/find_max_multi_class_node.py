...
if __name__ == "__main__":
    ...
    for file_name in os.listdir(folder_path):
        ...
        if file_name.endswith(".txt") and file_suffix in file_name:
            ...
            max_scores[file_name] = {"Max ACC": max_auc, "Max F1 score": max_f1}
    ...
    with open(output_csv_path, mode='w', newline='') as csv_file:
        ...
        # Write the header
        writer.writerow(["File", "Max ACC", "Max F1 score"])
        # Write the max scores for each file
        for file_name in sorted_files:
            writer.writerow([file_name, max_scores[file_name]["Max ACC"], max_scores[file_name]["Max F1 score"]])
