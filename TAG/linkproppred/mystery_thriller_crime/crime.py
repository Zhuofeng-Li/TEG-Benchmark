...
class Crime(InMemoryDataset):
    ...
    def raw_dir(self) -> str:
        return osp.join(self.root, 'mystery_thriller_crime_dataset', 'raw')

    @property
    def processed_dir(self) -> str:
        return osp.join(self.root, 'mystery_thriller_crime_dataset', 'processed')
    ...
    def process(self) -> None:
        path = osp.join(self.raw_dir, 'goodreads_reviews_mystery_thriller_crime.json')
