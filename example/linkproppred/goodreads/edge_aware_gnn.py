...
from TAG.linkproppred.mystery_thriller_crime import Crime
from TAG.linkproppred.comics_graphic import Comics
...
if __name__ == "__main__":
    ...
    parser.add_argument('--emb_type', '-et', type=str, default='GPT-3.5-TURBO',
                        help='embedding type for embeddings, options are GPT-3.5-TURBO, Bert, Angle, None')
